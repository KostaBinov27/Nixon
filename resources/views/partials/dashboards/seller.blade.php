...
if (isset($_POST['addNewProduct'])) {
    ...
    $sql = "SELECT * FROM pakcage_orders WHERE vendor_id = '".$_SESSION['userID']."'";
...
<?php
    ...
    <div class="container">
        <div class="text-center mt-5">
            <h3>Choose One of the Packages</h3>
        </div>
        <div class="row mt-5 rowPackages">
            <div class="col-lg-6 text-center">
                <div class="card m-auto" style="width: 18rem;">
                    <i class="fas fa-suitcase fa-5x mt-3" aria-hidden="true"></i>
                    <h4 class="card-title mt-3">LIMITED POSTS</h4>
                    <p>$25.00</p>
                    <hr>
                    <div class="card-body">
                        ...
                        <a href="/nixon/cart/?add-to-cart=196" class="btn btn-primary btnHomeBuyNow">Buy Now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 text-center">
                <div class="card m-auto" style="width: 18rem;">
                    ...
                    <h4 class="card-title mt-3">UNLIMITED POSTS</h4>
                    <p>$59.00</p>
                    <hr>
                    <div class="card-body">
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        ...
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="/nixon/cart/?add-to-cart=197" class="btn btn-primary btnHomeBuyNow">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
